...
const props=(): React.ComponentProps<typeof OrderCart> => ({items:[] as any[],notes:"",total:0,pending:false,canSubmit:false,courseMode:false,onQty:vi.fn(),onEdit:vi.fn(),onCourse:vi.fn(),onNotes:vi.fn(),onSubmit:vi.fn()});
