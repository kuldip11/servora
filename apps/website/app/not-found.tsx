...
export default function NotFound() {
  return (
    <section className="mx-auto max-w-3xl px-6 py-24 text-center lg:px-8">
      ...
      <p className="mt-5 text-[var(--text-secondary)]">The page you requested does not exist or has moved.</p>
      <Link href="/" className="mt-8 inline-flex rounded-lg bg-[var(--primary)] px-5 py-3 text-sm font-semibold text-white">
        Back to Servora
      </Link>
    </section>
  );
