export type ServoraAppId =
  "website" | "web" | "waiter" | "kitchen" | "customer";
...
export const SERVORA_APPS: Record<ServoraAppId, ServoraAppSeo> = {
  website: {
    ...
    description:
      "Connected restaurant operations software for orders, kitchens, teams, inventory, analytics and customer ordering.",
    indexable: true,
    ogEyebrow: "SERVORA",
    ogHeadline: "Every order. Every team. One flow.",
    ogDescription:
      "Restaurant operations, connected from guest order to kitchen and business insight.",
  },
  web: {
    id: "web",
    ...
    description:
      "Servora business operations, point of sale and restaurant administration.",
    indexable: false,
    ogEyebrow: "SERVORA BUSINESS",
    ogHeadline: "Run the restaurant from one connected workspace.",
    ogDescription:
      "Orders, menus, teams, inventory, analytics and administration in Servora Business.",
  },
  waiter: {
    id: "waiter",
    name: "Servora Waiter",
    ...
    ogDescription:
      "Take orders, manage tables and keep service moving with Servora Waiter.",
  },
  kitchen: {
    id: "kitchen",
    ...
    description:
      "Servora kitchen display workspace for restaurant order preparation.",
    indexable: false,
    ogEyebrow: "SERVORA KITCHEN",
    ogHeadline: "Every ticket. Clear priorities. One kitchen flow.",
    ogDescription:
      "Keep preparation visible, ordered and connected with Servora Kitchen.",
  },
  customer: {
    id: "customer",
    ...
    ogDescription:
      "A simple table-ordering experience connected directly to restaurant operations.",
  },
};
