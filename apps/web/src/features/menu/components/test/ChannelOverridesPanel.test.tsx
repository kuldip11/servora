...
describe("ChannelOverridesPanel", () => {
  ...
  it("saves and removes channel overrides", async () => {
    h.queryData.set(JSON.stringify(["menu-items", "i1", "channel-overrides"]), [
      {
        id: "co1",
        channel: "STAFF",
    ...
    await waitFor(() =>
      expect(h.saveChannelOverride).toHaveBeenCalledWith(
        "i1",
