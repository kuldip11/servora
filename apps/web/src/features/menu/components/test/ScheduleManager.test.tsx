...
vi.mock("@/features/menu/hooks/useMenuItemSchedules", () => ({
  useMenuItemSchedules: () => ({ data: h.schedules, isLoading: h.loading }),
}));
vi.mock("@/features/menu/hooks/useAddSchedule", () => ({
  useAddSchedule: () => ({ mutate: h.create, isPending: h.pending }),
}));
vi.mock("@/features/menu/hooks/useDeleteSchedule", () => ({
  useDeleteSchedule: () => ({ mutate: h.remove }),
}));
